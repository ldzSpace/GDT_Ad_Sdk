...
//import com.kds.adv.image.util.ImageSizeUtil.ImageSize;
...
public class ImageLoader {
	 ...
	 * @param imageView
	 */
	public void loadImage(final String path, final ImageView imageView, final boolean isFromNet, final ImageLoadingListener loadingListener) {
		LogUtils.v(TAG, "loadImage");
						...
						if (imageview.getTag().toString().equals(path)) {
							if (bm == null) {
								if (loadingListener != null)
									loadingListener.onLoadingFailed(path, imageview, "LoadingFailed");
							} else {
								imageview.setImageBitmap(bm);
								if (loadingListener != null)
									loadingListener.onLoadingComplete(path, imageview, bm);
							}
